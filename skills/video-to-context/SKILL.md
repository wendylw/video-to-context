...
description: Analyze local videos and screen recordings by converting them into timestamped AI-readable context bundles with metadata, contact sheets, and frames. Use when inspecting, debugging, summarizing, or locating an event in MP4, MOV, MKV, or WebM files, especially when the current model cannot consume video directly.
---
